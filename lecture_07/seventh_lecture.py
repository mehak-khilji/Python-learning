...
# read mode read the whole data so, we cannot use read-line to read data line by line
...
# if we open non existing file in write or append mode python automatically create that file. for example
